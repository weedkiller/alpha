...
{
    public class SallaryPaymentController : Controller
    {
        ...
        public SallaryPaymentController()
        {
        ...
        public ActionResult Index()
        {
            ...
            return PartialView("~/Views/SallaryPayment/SallaryPayment.cshtml", model);
        }
        ...
        {
            var model = SpendingPaymentTableVm.ToViewModel(_SpendingPaymentService.GetSallaryPaymentSummary(SelectedProvider, SelectedUser, DateFromExecution, DateToExecution, DateFromSystem, DateToSystem, AmountFrom, AmountTo, BalanceFrom, BalanceTo, Receipt, PositiveBalance));
            return PartialView("~/Views/SallaryPayment/SallaryPaymentTable.cshtml", model);
        }
        ...
        {
            var model = SpendingPaymentDetailTableVm.ToViewModel(_SpendingPaymentService.GetSallaryPaymentDetailSummary(SelectedProvider, SelectedUser, DateFromExecution, DateToExecution, DateFromSystem, DateToSystem, AmountFrom, AmountTo, BalanceFrom, BalanceTo, Receipt, PositiveBalance));
            return PartialView("~/Views/SallaryPayment/SallaryPaymentTableDetail.cshtml", model);
        }
        ...
        public ActionResult IndexSpendings(int ProviderId)
        {
            ...
            var collections = new CollectionHelper();
            model.ddlSpendings = collections.GetSpendingsByEmployeeSingleSelectVm(ProviderId);
            List<SpendingPaymentDetail> lists = new List<SpendingPaymentDetail>();
            model.Details = lists;
            Session["SessionSpendingPayment"] = model;
            return PartialView("~/Views/SallaryPayment/SpendingsTable.cshtml", model);
        }
        ...
        public ActionResult IndexPaymentMethod()
        {
            ...
            return PartialView("~/Views/SallaryPayment/PaymentMethodTable.cshtml", model);
        }
        ...
        public ActionResult Spendings(int? SpendigId, double AmountSpending)
        {
            ...
            if (SpendigId.HasValue)
            {
                ...
                detail.Spending = _spendingService.GetSpendingsById(SpendigId.Value).Period;
                ...
                if (existe == false)
                {
                    ...
                    return PartialView("~/Views/SallaryPayment/SpendingsTable.cshtml", principal);
                }
                else
                {
        ...
        public ActionResult PaymentMethod(int? PaymentMethod, double Amount)
        {
            ...
            if (PaymentMethod.HasValue)
            {
                ...
                {
                    ViewBag.ErrorMessagePayment = "false";
                    return PartialView("~/Views/SallaryPayment/PaymentMethodTable.cshtml", principal);
                }
                else
                {
        ...
        public ActionResult RemovePayments(int Id)
        {
            ...
            return PartialView("~/Views/SallaryPayment/PaymentsTable.cshtml", principal);
        }
        ...
        public ActionResult Create(SpendingPaymentVm model)
        {
            try
            {
                ...
                _SpendingPaymentService.AddSallaryPayment(SpendingPayment);
        ...
        public ActionResult View(int id)
        {
            ...
            return PartialView("~/Views/SallaryPayment/SallaryPaymentView.cshtml", model);
        }
        ...
        public ActionResult Edit(int id)
        {
            ...
            model.ddlPaymentMethods = collections.GetPaymentMethodSingleSelectVm();
            model.ddlPaymentMethodPM = collections.GetPaymentMethodSingleSelectVm();
            model.ddlSpendings = collections.GetSpendingsByEmployeeSingleSelectVm(entity.ProveedorId.Value);
            model.Saving = _cashierService.GetCashiersById(_userService.GetUserCashierByUserId(_profileProvider.CurrentUserId).CashierId).Name;
            if (entity.Balance > 0)
            {
                model.AdvancementAmount = entity.Balance;
            ...
            Session["SessionSpendingPayment"] = model;
            if (_SpendingPaymentService.IsEditableSallary(id))
                return PartialView("~/Views/SallaryPayment/SallaryPaymentEdit.cshtml", model);
            else
                return PartialView("~/Views/SallaryPayment/SallaryPaymentEditShort.cshtml", model);
        ...
        public ActionResult Edit(SpendingPaymentVm model)
        {
            try
            {
                ...
                _SpendingPaymentService.UpdateSallaryPayment(SpendingPayment);
        ...
        public ActionResult EditShort(SpendingPaymentVm model)
        {
            try
            {
                ...
                _SpendingPaymentService.UpdateSallaryPaymentShort(SpendingPayment);
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                if (_SpendingPaymentService.IsEditableSallary(id))
                {
                    ...
                    return new HttpStatusCodeResult(HttpStatusCode.InternalServerError, "No se puede eliminar el pago del sueldo");
            }
            catch (Exception ex)
            {
                return new HttpStatusCodeResult(HttpStatusCode.InternalServerError, "Error al guardar");
        ...
        {
            var model = SpendingTableVm.ToViewModel(_spendingService.GetSpendingSallarySummary(int.Parse(Session["ImputProvider"].ToString()), null, DateFromExecution, DateToExecution, DateFromExpiration, DateToExpiration, AmountFrom, AmountTo, BalanceFrom, BalanceTo, Receipt, "1", "0", "0"));
            return PartialView("~/Views/SallaryPayment/SpendingTable.cshtml", model);
        }

        public ActionResult GetTableImputAll()
        {
            var model = SpendingTableVm.ToViewModel(_spendingService.GetSpendingSallarySummary(int.Parse(Session["ImputProvider"].ToString()), null, "", "", "", "", "", "", "", "", "", "1", "0", "0"));
            return PartialView("~/Views/SallaryPayment/SpendingTable.cshtml", model);
        }
        ...
        public ActionResult AddImput(int SpendingId, double Amount)
        {
            ...
            Session["SpendingImputModel"] = model;
            var modeld = SpendingTableVm.ToViewModel(_spendingService.GetSpendingSallarySummaryWithOutImput(int.Parse(Session["ImputProvider"].ToString()), null, "", "", "", "", "", "", "", "", "", "1", "0", "0", spe));
            return PartialView("~/Views/SallaryPayment/SpendingTable.cshtml", modeld);
        }
        ...
        public ActionResult CreateImput(SpendingFilterVm model)
        {
            try
            {
                ...
                _SpendingPaymentService.AddImputSallarySpending(model.SpendingPaymentId, model.Imput, (List<SpendingPaymentDetail>)model.Details);
                return Index();
            }
            catch (Exception ex)
            {
