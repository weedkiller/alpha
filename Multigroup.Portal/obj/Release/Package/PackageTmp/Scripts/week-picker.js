(function () {
    ...
    WeekPicker.prototype = {
        ...
        init:function () {
            ...
            $calendar = $("<table>").addClass('calendar table-condensed');
            this.$months = $('<tr>');
        ...
        nav: function (months) {
            ...
            var $subnav = $('<div><span class="prev button">&larr; Anterior </span> | <span class="next button">Siguiente &rarr;</span></div>');
