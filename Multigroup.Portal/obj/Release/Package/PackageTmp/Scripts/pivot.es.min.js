(function () {
    ...
    callWithJQuery(function ($) {
        ...
        renderers = {
            ...
            //"Tabla Barchart": function (pvtData, opts) {
        ...
        locales = {
            en: {
                ...
                localeStrings: {
                    ...
                    selectAll: '<i class="fa fa-check-square-o">',
                    selectNone: '<i class="glyphicon glyphicon-remove-circle">',
                    tooMany: "(Demasiados para mostrar en lista)",
        ...
        $.fn.pivotUI = function (input, inputOpts, overwrite, locale) {
            ...
            try {
                ...
                rendererControl = $("<td>").addClass('pvtAxisContainer');
                ...
                colList = $("<td>").addClass('pvtAxisContainer pvtUnused').html('<span style="font-weight: 600">Dimensiones:</span>');
                ...
                fn = function (c) {
                    ...
                    valueList.append($("<h4>").addClass('pvtTitleModal').text(c + " (" + keys.length + ")"));
                    if (keys.length > opts.menuLimit) {
                        valueList.append($("<p>").html(opts.localeStrings.tooMany));
                    } else {
                        btns = $("<div>").addClass('input-group').appendTo(valueList);
                        btns.append($("<input>", {
                            type: "text",
                        ...
                        spanBtn1 = $("<span>").addClass('input-group-btn').appendTo(btns);
                        spanBtn1.append($("<button>", {
                            type: "button"
                        }).addClass('btn btn-default').html(opts.localeStrings.selectAll).bind("click", function () {
                            return valueList.find("input:visible").prop("checked", true);
                        }));
                        spanBtn2 = $("<span>").addClass('input-group-btn').appendTo(btns);
                        spanBtn2.append($("<button>", {
                            type: "button"
                        }).addClass('btn btn-default multiselect-clear-filter').html(opts.localeStrings.selectNone).bind("click", function () {
                    ...
                    $("<div>").addClass('pvtFiltrar').appendTo(valueList).append($("<button>", {
                        type: "button"
                    }).text("Filtrar").addClass('btn btn-default').bind("click", updateFilter));
                    ...
                    triangleLink = $("<span>").addClass('pvtTriangle').addClass("caret").bind("click", showFilterList);
                ...
                $("<td>").addClass('pvtAxisContainer pvtHorizList pvtCols').html('<span style="font-weight: 600">Columnas:</span>').appendTo(tr1);
                tr2 = $("<tr>").appendTo(uiTable);
                tr2.append($("<td>").addClass('pvtAxisContainer pvtRows').html('<span style="font-weight: 600">Filas:</span>').attr("valign", "top"));
