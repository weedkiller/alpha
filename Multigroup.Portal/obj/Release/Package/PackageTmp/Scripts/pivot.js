(function() {
  ...
  callWithJQuery(function($) {
    ...
    aggregators = (function(tpl) {
      return {
        "Ocurrencias": tpl.count(usFmtInt),
          ...
          return function() {
            ...
            if (numInputsToProcess !== 0) {
              ...
              for (x = s = 0, ref6 = numInputsToProcess; 0 <= ref6 ? s < ref6 : s > ref6; x = 0 <= ref6 ? ++s : --s) {
                  newDropdown = $("<select>").addClass('pvtAttrDropdown').attr('style', 'display:none').append($("<option>").val('Valor').text('Valor')).bind("change", function() {
                  return refresh();
                });
