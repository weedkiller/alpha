(function() {
  ...
  callWithJQuery(function($) {
    ...
    makeGoogleChart = function(chartType, extraOptions) {
      return function(pivotData, opts) {
        ...
        if ((base = opts.gchart).width == null) {
            base.width = $('.portlet-body').width() / 1.2
        }
        if ((base1 = opts.gchart).height == null) {
          base1.height = window.innerHeight / 2;
        }
    ...
    return $.pivotUtilities.gchart_renderers = {
        "Gr&aacute;fico de Linea": makeGoogleChart("LineChart"),
        "Gr&aacute;fico de Barra": makeGoogleChart("ColumnChart"),
        "Gr&aacute;fico de Barra Apilado": makeGoogleChart("ColumnChart", {
        isStacked: true
      }),
        "Gr&aacute;fico de Area": makeGoogleChart("AreaChart", {
        isStacked: true
      }),
        "Gr&aacute;fico de Dispersi&oacute;n": makeGoogleChart("ScatterChart")
    };
  });
