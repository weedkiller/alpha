...
var Metronic = function () {
    ...
    $("#toggleSidebar").click(function () {
        if ($('#sidebarMenu').hasClass('page-sidebar-menu-closed') == false) {
            $(this).css('transform', 'rotateY(180deg)');
        } else {
            $(this).css('transform', 'rotateY(360deg)');
        }
    });
    //CLICK ENTRADAS DE MENU
    $(".sub-menu li").on("click", function () {
        if (!$(this).hasClass('first-submenu')) {
            $(".page-sidebar-menu li").removeClass("active open");
            $(this).addClass("active");
            $(this).parents().eq(1).addClass("active open");
        }
    });
    ...
    var handlePortletTools = function () {
        ...
        $('body').on('click', '.portlet > .portlet-title .exportToPopup', function (e) {
            e.preventDefault();
    ...
    // Descargar graficos
    var downloadCharts = function () {
        var chartPNG;
        $('.save-as-image').click(function (event) {
            var chartPNG = $(this).closest(".portlet-body").children(".bar-chart-container").children(".svg-container").children("svg");
            var nombreGrafico = $(this).closest(".portlet-body").parent(".portlet").children(".portlet-title").children(".caption").text().trim();
            LoadImage(chartPNG, nombreGrafico);
        });

        function LoadImage(chartPNG, nombreGrafico) {
            saveSvgAsPng(chartPNG[0], 'grafico-'+nombreGrafico+'.png');
            //saveSvgAsPng(d3.select(".bar-chart-container .svg-container svg").node(), 'grafico.png');
        }
        (function () {
