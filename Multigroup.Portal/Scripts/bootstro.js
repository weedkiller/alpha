    ...
    (function( bootstro, $, undefined ) {
        ...
        function add_nav_btn(content, i)
        {
            ...
            if (bootstrapVersion == 2)
                defaultBtnClass = "btn btn-default btn-mini";
            else 
                defaultBtnClass = "btn btn-default btn-xs"; //default bootstrap version 3
            ...
            {
                if (i == 0)
                    content = content + finishButton + nextButton;
                else if (i == count -1 )
...
//content = content ;
        ...
        get_popup = function(i)
        {
            ...
            if (count > 1)
            {
                t = "<span class='label label-default'>" + (i +1)  + "/" + count + "</span>";
            }
