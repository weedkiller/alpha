...
namespace Multigroup.Repositories.Shared
{
    public class ProviderRepository : BaseRepository
    {
        ...
        {
            var data = Db.ExecuteSprocAccessor("pub_ProviderSummary_GetList", ProviderSummaryMapper.Mapper, ProviderType, DateFrom, DateTo, BalanceFrom, BalanceTo, active, "0");
        ...
        {
            var data = Db.ExecuteSprocAccessor("pub_IVAPosition_GetList", IVAPositionMapper.Mapper);
        ...
        {
            var data = Db.ExecuteSprocAccessor("pub_ProviderCurrentAcount_GetList", ProviderCurrentAcountMapper.Mapper, Providers, BalanceFrom, BalanceTo, NotImput);
        ...
        {
            var data = Db.ExecuteSprocAccessor("pub_ProviderCurrentAcountDetail_GetList", ProviderCurrentAcountDetailMapper.Mapper, providerId);
        ...
        public void AddProvider(Provider Provider)
        {
            ...
            Db.AddInParameter(command, "@IsEmployee", DbType.Boolean, false);
            ...
            Db.AddInParameter(command, "@IVAPositionId", DbType.Int32, Provider.IVAPositionId);
            Db.AddInParameter(command, "@BusinessName", DbType.String, Provider.BusinessName);
            Db.AddInParameter(command, "@CUIT", DbType.String, Provider.CUIT);
        ...
        public void UpdateProvider(Provider Provider)
        {
            ...
            Db.AddInParameter(command, "@Document", DbType.String, Provider.Document);
            Db.AddInParameter(command, "@Email", DbType.String, Provider.Email);
            Db.AddInParameter(command, "@IsEmployee", DbType.Boolean, Provider.IsEmployee);
            Db.AddInParameter(command, "@ProviderTypeId", DbType.Int32, Provider.ProviderTypeId);
            Db.AddInParameter(command, "@Telephone", DbType.String, Provider.Telephone);
            Db.AddInParameter(command, "@UserId", DbType.String, 0);
            Db.AddInParameter(command, "@IVAPositionId", DbType.Int32, Provider.IVAPositionId);
            Db.AddInParameter(command, "@BusinessName", DbType.String, Provider.BusinessName);
            Db.AddInParameter(command, "@CUIT", DbType.String, Provider.CUIT);
            Db.ExecuteScalar(command);
